		...
		public virtual void AddContextMenus(ref ToolStripMenuItem groupMenu, ref ToolStripMenuItem positionMenu, ref ToolStripMenuItem orderMenu, ref ToolStripMenuItem miscMenu)
			{
				...
				if (num > 0)
				{
					if (Z < num)
					{
						orderMenu.DropDownItems.Add(new ToolStripMenuItem("Move Front", null, DoMoveFrontMenu));
						orderMenu.DropDownItems.Add(new ToolStripMenuItem("Move First", null, DoMoveFirstMenu));
					}

					if (Z >= 1)
					{
						orderMenu.DropDownItems.Add(new ToolStripMenuItem("Move Back", null, DoMoveBackMenu));
						orderMenu.DropDownItems.Add(new ToolStripMenuItem("Move Last", null, DoMoveLastMenu));
					}
				}
				...
				if (selected > 1)
				{
					positionMenu.DropDownItems.Add(new ToolStripMenuItem("Align Lefts", null, DoAlignLeftsMenu));
					positionMenu.DropDownItems.Add(new ToolStripMenuItem("Align Rights", null, DoAlignRightsMenu));
					positionMenu.DropDownItems.Add(new ToolStripMenuItem("Align Tops", null, DoAlignTopsMenu));
					positionMenu.DropDownItems.Add(new ToolStripMenuItem("Align Bottoms", null, DoAlignBottomsMenu));
					positionMenu.DropDownItems.Add(new ToolStripSeparator());
					positionMenu.DropDownItems.Add(new ToolStripMenuItem("Center Horizontally", null, DoAlignCentersMenu));
					positionMenu.DropDownItems.Add(new ToolStripMenuItem("Center Vertically", null, DoAlignMiddlesMenu));

					if (selected > 2)
					{
						positionMenu.DropDownItems.Add(new ToolStripSeparator());
						positionMenu.DropDownItems.Add(new ToolStripMenuItem("Equalize Vertical Spacing", null, DoVerticalSpacingMenu));
						positionMenu.DropDownItems.Add(new ToolStripMenuItem("Equalize Horizontal Spacing", null, DoHorizontalSpacingMenu));
					}
				}
			}
