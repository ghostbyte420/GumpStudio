...
namespace GumpStudio.Elements
{
	...
	public class GroupElement : BaseElement
	{
		...
		public override void AddContextMenus(ref ToolStripMenuItem GroupMenu, ref ToolStripMenuItem PositionMenu, ref ToolStripMenuItem OrderMenu, ref ToolStripMenuItem MiscMenu)
			{
				base.AddContextMenus(ref GroupMenu, ref PositionMenu, ref OrderMenu, ref MiscMenu);

				if (_Parent.GetSelectedElements().Count() > 1)
				{
					GroupMenu.DropDownItems.Add(new ToolStripMenuItem("Add Selection to Group", null, DoAddMenu));
				}

				GroupMenu.DropDownItems.Add(new ToolStripMenuItem("Break Group", null, DoBreakGroupMenu));
				MiscMenu.DropDownItems.Add(new ToolStripMenuItem("Export Gumpling", null, DoExportGumplingMenu));
			}
