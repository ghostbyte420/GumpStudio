	...
	public class StaticArtBrowser : Form
	{
		...
		protected void BuildCache()
		{
			...
			try
			{
				...
				using (var writer = new StreamWriter(fileStream)) { writer.Write(json); }
				fileStream = null;
			}
			catch (Exception ex)
			{
		...
		private void InitializeComponent()
		{
			...
			_picCanvas.Size = new Size(586, 383);
			...
			_vsbScroller.Location = new Point(586, 0);
			_vsbScroller.Name = "_vsbScroller";
			_vsbScroller.Size = new Size(20, 383);
			...
			_txtSearch.Location = new Point(67, 392);
			_txtSearch.Name = "_txtSearch";
			_txtSearch.Size = new Size(123, 23);
			_txtSearch.TabIndex = 4;
			// 
			// _cmdSearch
			// 
			_cmdSearch.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
			_cmdSearch.Location = new Point(195, 392);
			_cmdSearch.Name = "_cmdSearch";
			_cmdSearch.Size = new Size(60, 25);
			...
			_lblName.Location = new Point(262, 394);
			...
			_lblSize.Location = new Point(493, 394);
			_lblSize.Name = "_lblSize";
			_lblSize.Size = new Size(30, 15);
			_lblSize.TabIndex = 7;
			_lblSize.Text = "Size:";
			// 
			// _cmdCache
			...
			_cmdCache.Location = new Point(3, 391);
			_cmdCache.Name = "_cmdCache";
			_cmdCache.Size = new Size(60, 28);
			...
			_lblWait.Location = new Point(180, 104);
			_lblWait.Name = "_lblWait";
			_lblWait.Size = new Size(221, 128);
			...
			_lblID.Location = new Point(262, 424);
			_lblID.Name = "_lblID";
			_lblID.Size = new Size(21, 15);
			_lblID.TabIndex = 11;
			_lblID.Text = "ID:";
			// 
			// StaticArtBrowser
			...
			MaximumSize = new Size(625, 3692);
			MinimumSize = new Size(625, 246);
			...
			if (Cache == null)
			{
				...
				else
				{
					try
					{
						...
						Cache = JsonSerializer.Deserialize<GumpCacheEntry[]>(fileStream);
					}
					catch (Exception ex)
					{
						ProjectData.SetProjectError(ex);
