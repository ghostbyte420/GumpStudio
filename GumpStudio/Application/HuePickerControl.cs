...
namespace GumpStudio
{
	public class HuePickerControl : UserControl
	{
		...
		private void cboQuick_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				case "Colors": s = "0"; break;
				case "Skin": s = "1001"; break;
				case "Hair": s = "1101"; break;
				case "Interesting #1": s = "1049"; break;
				case "Pinks": s = "1200"; break;
				case "Elemental Weapons": s = "1254"; break;
				case "Interesting #2": s = "1278"; break;
				case "Blues": s = "1300"; break;
				case "Elemental Wear": s = "1354"; break;
				case "Greens": s = "1400"; break;
				case "Oranges": s = "1500"; break;
				case "Reds": s = "1600"; break;
				case "Yellows": s = "1700"; break;
				case "Neutrals": s = "1800"; break;
				case "Snakes": s = "2000"; break;
				case "Birds": s = "2100"; break;
				case "Slimes": s = "2200"; break;
				case "Animals": s = "2300"; break;
				case "Metals": s = "2400"; break;
			}
		...
		private void HuePickerControl_Load(object sender, EventArgs e)
		{
			...
			_StatusLabel.Text = Conversions.ToString(mHue.Index) + ": " + mHue.Name;
		}
		...
		private void InitializeComponent()
		{
			...
			// _StatusBar
			// 
			_StatusBar.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { _StatusLabel });
			_StatusBar.Location = new System.Drawing.Point(0, 242);
			_StatusBar.Name = "_StatusBar";
			_StatusBar.Size = new System.Drawing.Size(208, 22);
			_StatusBar.TabIndex = 0;
			// 
			// _StatusLabel
			// 
			_StatusLabel.Name = "_StatusLabel";
			_StatusLabel.Size = new System.Drawing.Size(0, 17);
			// 
			// _cboQuick
			// 
